import { Alert, Box, Button, Checkbox, FormControl, FormControlLabel, IconButton, InputLabel, MenuItem, Paper, Select, Snackbar, Switch, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Toolbar, Tooltip, Typography } from "@mui/material";
                        ...
                        {savedCourses.map((row) => (
                          <TableRow key={row.id}>
                            ...
                            <TableCell align="center">
                              <IconButton onClick={() => setSavedCourses(prev => prev.filter(p => p.id !== row.id))}>
